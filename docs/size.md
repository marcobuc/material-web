...
<sub>Last updated 2024-05-02.</sub>

<!-- mdformat off(autogenerated might break rendering in catalog) -->

| Component | gzip | minified | *% CSS* | Import |
| --- | --- | --- | --- | --- |
| **All** | **70.5kb** | 447.0kb | *65% CSS* | `@material/web/all.js` |
| **Common** | **52.4kb** | 281.9kb | *53% CSS* | `@material/web/common.js` |
